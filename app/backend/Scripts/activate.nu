...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\xampp\htdocs\end-to-end-encrypted-messaging\app\backend'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\xampp\htdocs\end-to-end-encrypted-messaging\app\backend\Scripts\deactivate.nu'
